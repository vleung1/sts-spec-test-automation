...
| `CADSR_BASE_URL` | Root URL for the caDSR REST API (manual module `test_cadsr_alternatevalues_draftnew_cdes.py`; paths like `/DataElement/{publicId}`) | `https://cadsrapi.cancer.gov/rad/NCIAPI/1.0/api` |
