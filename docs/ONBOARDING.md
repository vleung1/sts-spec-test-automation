...
| `STS_PARALLEL_WORKERS` | Max models to run concurrently in `scripts/run_autogenerated_tests.py` (set to `1` for sequential)              | `2`                            |
...
| `STS_PARALLEL_WORKERS` | Max models to run concurrently. Set to `1` for sequential execution.                          | `2`                                                |
