...
- **`run_all_term_verify.sh`** — all `tests/term_verify/*_term_verify.py`; outputs under `reports/term_value/<COMMONS>/`.
...
| `scripts/run_all_term_verify.sh`        | All term-verify Python scripts in sequence                                                               |
