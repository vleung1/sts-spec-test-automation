...
- **`run_autogenerated_tests.py`** — same OpenAPI functional pipeline as `tests/test_generated/`, but **CLI** timestamped HTML/JSON under `reports/<model>/`. Optional: `STS_MODELS=PSDC,CTDC`.
